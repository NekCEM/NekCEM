...
\begin{center}
  {\tmstrong{The 3D PML in all its gory detail}}
\end{center}

\begin{center}
  Andreas Kl{\"o}ckner \tmtexttt{<andreas@mcs.anl.gov>}
\end{center}

Define the PML Material tensor:
\[ \tilde{S} \assign S^{- 1} \left(\begin{array}{ccc}
     s_y s_z &  & \\
     & s_x s_z & \\
     &  & s_x s_y
   \end{array}\right), \quad S \assign \left(\begin{array}{ccc}
     s_x &  & \\
     & s_y & \\
     &  & s_z
   \end{array}\right) . \]

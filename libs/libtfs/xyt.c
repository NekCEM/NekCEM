/*$Id: xyt.c,v 1.6 2001/04/12 21:03:28 balay Exp $*/
/*************************************xyt.c************************************
Module Name: xyt
Module Info:
...
#ifdef MLSRC
void ML_XYT_solve(xyt_ADT xyt_handle, int lx, REAL *x, int lb, REAL *b);
...
int
#if defined UPCASE
XYT_SOLVE (int *n, REAL *x, REAL *b)
#else
xyt_solve_(int *n, REAL *x, REAL *b)
#endif
{
#ifdef NEK5000  
...
**************************************xyt.c***********************************/
int
XYT_solve(xyt_ADT xyt_handle, REAL *x, REAL *b)
{
...
**************************************xyt.c***********************************/
void 
ML_XYT_solve(xyt_ADT xyt_handle, int lx, REAL *sol, int lb, REAL *rhs)
{
